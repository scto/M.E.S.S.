...
public class Loading extends AbstractScreen {
	...
	private void afficherLoading() {
		...
		CSG.batch.begin();
		CSG.menuFont.draw(CSG.batch, loading[cpt], CSG.halfWidth - CSG.fontsDimensions.getWidth(CSG.menuFont, "Loading -") / 2, CSG.halfHeight - CSG.fontsDimensions.getHeight(CSG.menuFont, "Loading -") / 2);
		CSG.batch.end();
	}
