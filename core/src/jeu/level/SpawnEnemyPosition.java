...
public class SpawnEnemyPosition {
	...
	_05sur10 = new Vector2(CSG.screenWidth * 0.05f, CSG.height),
	_1sur10 = new Vector2(CSG.screenWidth * 0.1f, CSG.height),
	_2sur10 = new Vector2(CSG.screenWidth * 0.2f, CSG.height),
	_3sur10 = new Vector2(CSG.screenWidth * 0.3f, CSG.height),
	_4sur10 = new Vector2(CSG.screenWidth * 0.4f, CSG.height),
	_5sur10 = new Vector2(CSG.screenWidth * 0.5f, CSG.height),
	_6sur10 = new Vector2(CSG.screenWidth * 0.6f, CSG.height),
	_7sur10 = new Vector2(CSG.screenWidth * 0.7f, CSG.height),
	_8sur10 = new Vector2(CSG.screenWidth * 0.8f, CSG.height),
	_9sur10 = new Vector2(CSG.screenWidth * 0.9f, CSG.height),
	_95sur10 = new Vector2(CSG.screenWidth * 0.95f, CSG.height);
	private static final Vector2 _bossSatUp = new Vector2((CSG.screenWidth-1)+Sat.DIMENSIONS.halfWidth, CSG.height * 0.7f);
	private static final Vector2 _bossSatDown = new Vector2((CSG.screenWidth-1)+Sat.DIMENSIONS.halfWidth, CSG.height * 0.35f);
