...
public enum Dimensions {
	...
	FIREBALL(2, 3f), FRAG_METEORITE(2.25f), INSECT_WEAPON(2), KINDER_WEAPON(2), LASER_WEAPON(2), METEORITE(3), MINE(3f), PINK_BULLET(2.5f), RAINBOW(1.75f, 2.15f), SMALL_FIREBALL(FIREBALL, 0.6f),
	...
	ORANGE_BULLET(1.95f), ADD_SAT(3), BOSS_MINE(5, 14), BOSS_QUAD(18.9f, 9.45f), SAT(16.2f), FRAG_WEAPON(1,2), METEOR(8);
	
	public float width, height, halfWidth, halfHeight, quartWidth, threeQuarterWidth, quartHeight;
