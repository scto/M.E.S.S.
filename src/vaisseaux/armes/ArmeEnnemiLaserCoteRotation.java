 ...
 * @author Julien
 */
public class ArmeEnnemiLaserCoteRotation extends Armes implements Poolable{
	
	public static final int LARGEUR= CSG.LARGEUR_ECRAN / 32;
	public static final int DEMI_LARGEUR = LARGEUR/2; 
	public static final float CADENCETIR = .03f;
	public static Pool<ArmeEnnemiLaserCoteRotation> pool = Pools.get(ArmeEnnemiLaserCoteRotation.class);
	...
	public boolean mouvementEtVerif() {
		if (Physique.mouvementDeBase(direction, position, Stats.VITESSE_MAX_ARME_BOULE_VERTE_ROTATION, LARGEUR))	return true;
		pool.free(this);
		return false;
	}

	@Override
	public int getForce() {		return 1;	}
