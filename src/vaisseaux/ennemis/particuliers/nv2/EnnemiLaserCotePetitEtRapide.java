...
public class EnnemiLaserCotePetitEtRapide extends Ennemis{

	public static final int LARGEUR = CSG.LARGEUR_ECRAN / 18;
	public static final int DEMI_LARGEUR = LARGEUR/2;
	public static Pool<EnnemiLaserCotePetitEtRapide> pool = Pools.get(EnnemiLaserCotePetitEtRapide.class);
	// ** ** animations
	 ...
	 */
	public EnnemiLaserCotePetitEtRapide() {
	...
	protected void tir() {
		if (!mort && prochainTir < maintenant) {
			ArmeEnnemiLaserCotePlusPetitePlusRapide gauche = ArmeEnnemiLaserCotePlusPetitePlusRapide.pool.obtain();
			gauche.init(position.x + DEMI_LARGEUR - ArmeEnnemiLaserCotePlusPetitePlusRapide.DEMI_LARGEUR, position.y + DEMI_LARGEUR - ArmeEnnemiLaserCotePlusPetitePlusRapide.DEMI_LARGEUR, angle, true);

			ArmeEnnemiLaserCotePlusPetitePlusRapide droite = ArmeEnnemiLaserCotePlusPetitePlusRapide.pool.obtain();
			droite.init(position.x + DEMI_LARGEUR - ArmeEnnemiLaserCotePlusPetitePlusRapide.DEMI_LARGEUR, position.y + DEMI_LARGEUR - ArmeEnnemiLaserCotePlusPetitePlusRapide.DEMI_LARGEUR, angle, false);
			
			prochainTir = (maintenant + ArmeEnnemiLaserCotePlusPetitePlusRapide.CADENCETIR * numeroTir);
