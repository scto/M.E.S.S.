...
//
//	public Lumieres() {
////		AtlasRegion tr = CSG.getAssetMan().getAtlas().findRegion("joueur3");
////		tr.
//		rock = new Texture(Gdx.files.internal("joueur3.pnga"));
//		rockNormals = new Texture(Gdx.files.internal("joueur3nm.png"));
//		
...
//				float x = Gdx.input.getX() / (float)CSG.LARGEUR_ECRAN;
//				float y = Gdx.input.getY() / (float)CSG.HAUTEUR_ECRAN;
//						
//				LIGHT_POS.x = x;
//				LIGHT_POS.y = y;
//				
