...
public final class SoundMan {
	...
	public static Sound explosion1, explosion2, bigExplosion, explosion3, explosion4, explosion5, explosion6, tirRocket, bonusTaken, sunWeapon, xp;
	...
	// if (CSG.profile.effectsVolume > MIN)
	// sonExplosion.play(CSG.profile.effectsVolume, 1, (CSG.gameZoneHalfWidth /
	// f) );
	// }
