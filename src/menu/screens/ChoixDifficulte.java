...
public class ChoixDifficulte extends AbstractScreen {
	...
	public void setUpScreenElements() {
		ajout(buttonBack);
		// ** ** ** PIECE OF CAKE ** ** **
		final Button lvl1 = new Button(Strings.LVL1, false, CSG.menuFont, BUTTON_WIDTH, BUTTON_HEIGHT, CSG.width / PADDING, CSG.height - BUTTON_HEIGHT * 5, new OnClick() {
			public void onClick() {
		...
		ajout(lvl1);
		// ** ** ** LET'S ROCK ** ** **
		final Button lvl2 = new Button(Strings.LVL2, false, CSG.menuFont, BUTTON_WIDTH, BUTTON_HEIGHT, CSG.width / PADDING, CSG.height - BUTTON_HEIGHT * 7.5f, new OnClick() {
			public void onClick() {
		...
		ajout(lvl2);
		// ** ** ** COME GET SOME ** ** **
		final Button lvl3 = new Button(Strings.LVL3, false, CSG.menuFont, BUTTON_WIDTH, BUTTON_HEIGHT, CSG.width / PADDING, CSG.height - BUTTON_HEIGHT * 10, new OnClick() {
			public void onClick() {
		...
		final Button lvl4 = new Button(Strings.LVL4, false, CSG.menuFont, BUTTON_WIDTH, BUTTON_HEIGHT, CSG.width / PADDING, CSG.height - BUTTON_HEIGHT * 12.5f, new OnClick() {
			public void onClick() {
				changeMenu(new EndlessMode(game, CSG.batch, 4, cheat));
			}
		});
		ajout(lvl4);
		final Button chooseWeapon = new Button(Strings.CHOOSE_WEAPON, false, CSG.menuFont, BUTTON_WIDTH, BUTTON_HEIGHT, CSG.width / PADDING, CSG.height - BUTTON_HEIGHT * 15.5f, new OnClick() {
			public void onClick() {
			}
		});
		ajout(chooseWeapon);
