...
public enum Dimensions {
	...
	TOURNANTE(1.8f), VICIOUS_BULLET(1.9f), DRONE_WEAPON(1.5f, 3.0f), BLUE_SWEEP_WEAPON(1), FIREBALL_PLAYER(2), PINK_WEAPON(2), SPACE_INVADER_WEAPON(6, 18), SUN_WEAPON(2), T_WEAPON(2, 2.6f), CYAN_BULLET(1.9f),
	ORANGE_BULLET(1.95f), ADD_SAT(3), BOSS_MINE(4, 16), BOSS_QUAD(18.9f, 9.45f), SAT(16.2f), FRAG_WEAPON(1,2);
