...
public class RoundAndRound extends Enemy {
	...
	private static final int 
		WIDTH = Stats.ROUND_AND_ROUND_WIDTH, 
		HALF_WIDTH = WIDTH/2, 
		HEIGHT = Stats.ROUND_AND_ROUND_HEIGHT, 
		HALF_HEIGHT = HEIGHT / 2;
	public static final int PK = 13;
	protected static final int BASE_XP = Enemy.initXp(21, PK);
	private static final int LVL = 1, HP = initHp(Stats.ROUND_AND_ROUND_HP, PK), XP = getXp(BASE_XP, LVL), EXPLOSION_MIN_PARTICLES = initExplosion(30, PK), SHOTS_GAP = 10;
	protected static final float FIRERATE = initFirerate(.45f, PK), INIT_NEXT_SHOT = initNextShot(0, PK), SPEED = initSpeed(20, PK);
