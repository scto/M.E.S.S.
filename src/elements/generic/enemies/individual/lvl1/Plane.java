...
public class Plane extends Enemy implements Tireur {
	...
	public void mouvementEtVerif() {
		if (EndlessMode.alternate)	Particles.smokeMoving(pos.x + OFFSET_SMOKE_LEFT, pos.y + OFFSET_SMOKE, true, PrecalculatedParticles.colorsRed);
		else						Particles.smokeMoving(pos.x + OFFSET_SMOKE_RIGHT, pos.y + OFFSET_SMOKE, true, PrecalculatedParticles.colorsRed);
