...
public class Vicious extends Enemy {
	...
	public static final int PK = 14, EXPLOSION = initExplosion(50, PK);
	public static final float WIDTH = (int) (Stats.INSECT_WIDTH * 0.75f),  HALF_WIDTH = WIDTH / 2, FIRERATE = initFirerate(2, PK), INIT_NEXT_SHOT = initNextShot(1, PK), SPEED = initSpeed(3, PK);
	...
	protected static final Phase[] PHASES = {
		new Phase(				Behavior.STRAIGHT_ON,				Gatling.VICIOUS,				Shot.SHOTGUN,				Animations.INSECT_GOOD				)		};
	private int xp, hp;
	...
	public Vector2 getShotPosition(int numeroTir) {
		dir.y -= Stats.uDiv4;
		TMP_POS.x = pos.x + HALF_WIDTH - ViciousBullet.HALF_WIDTH;
		TMP_POS.y = pos.y + HALF_WIDTH - ViciousBullet.HALF_WIDTH;
		return TMP_POS;
	}

	@Override	public float getShootingAngle() {			return 180;															}
