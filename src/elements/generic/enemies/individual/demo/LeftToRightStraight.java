...
public class LeftToRightStraight extends Enemy {
	...
	public static final Pool<LeftToRightStraight> POOL = new Pool<LeftToRightStraight>(16) {
		@Override
		protected LeftToRightStraight newObject() {
			return new LeftToRightStraight();
		}
	};
