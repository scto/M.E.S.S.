...
public class Prototype extends Enemy {
	...
	public static final Pool<Prototype> POOL = new Pool<Prototype>(16) {
		@Override
...
//	private static final Phase[] PHASES = {		new Phase(				Behavior.STRAIGHT_ON,				null,				null,				Animations.BASIC_ENEMY_RED				)};
	...
	private boolean way = false, scale = CSG.R.nextBoolean();
	...
	@Override
	public boolean getShotWay() {
		return scale;
	}
	@Override
	public void setShotWay(boolean b) {
		this.scale = b;
	}
	@Override
