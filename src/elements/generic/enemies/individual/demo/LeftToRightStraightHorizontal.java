...
public class LeftToRightStraightHorizontal extends Enemy {
	...
	public static final Pool<LeftToRightStraightHorizontal> POOL = new Pool<LeftToRightStraightHorizontal>(16) {
		@Override
		protected LeftToRightStraightHorizontal newObject() {
			return new LeftToRightStraightHorizontal();
		}
	};
